...
Important note: The plugin name is what [Wyzcrak](https://github.com/lancehilliard) calls the extension/plugin in his code but they do not always correspond to a lua script (lua filename might not relate to how plugin is named).
